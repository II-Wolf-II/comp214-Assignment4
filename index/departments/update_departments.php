...
<body>
    <div class="container">
        <h1>Update Department Records</h1>
        <form action="department_update_handler.php" method="POST">
            <table>
                <thead>
                    <tr>
                        <th>Department ID</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="department_name[<?php echo htmlspecialchars($department['DEPARTMENT_ID']); ?>]" value="<?php echo htmlspecialchars($department['DEPARTMENT_NAME']); ?>"></td>
                        <td><input type="text" name="manager_id[<?php echo htmlspecialchars($department['DEPARTMENT_ID']); ?>]" value="<?php echo htmlspecialchars($department['MANAGER_ID']); ?>"></td>
                        <td><input type="text" name="location_id[<?php echo htmlspecialchars($department['DEPARTMENT_ID']); ?>]" value="<?php echo htmlspecialchars($department['LOCATION_ID']); ?>"></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
